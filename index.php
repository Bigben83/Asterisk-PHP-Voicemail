...
<div class="container">
    ...
    <div class="">	
		...
		<div class="row">
			<div class="col-md"><h3><?php echo $mbinfo['fullname']; ?></h3></div>
		</div>
		
		<div class="row">
			<div class="col-md-6 text-center">Current folder: <i><?php echo $folder_name; ?></i></div>
			<div class="col-md-6 text-center"><b>Mailbox </b><?php echo $mbinfo['mailbox']; ?></div>
		</div>
			
		<div class="row">
			<div class="col-md">
			<form method="POST">
					<table class="table expand hover striped">
						<thead>
							<tr>
								<td>Caller ID:</td>
								<td>Received:</td>
						...
						<?php
							...
							foreach($arr_messages as $arr_msg)
							{
								echo "<tr>";
									...
									echo "<td><a href=\"http://192.168.1.200/voicemail/mp3stream.php/".$arr_msg['shortfile'].".wav\" target=\"_BLANK\" title=\"Click to play.\">\n";
									...
									foreach($folder_list as $index => $value)
									{
										echo "<input class=\"btn btn-secondary btn-sm mx-1\" type=\"submit\" name=\"move[".$arr_msg['shortfile'].":$index]\" value=\"$index\">";
									}
									echo "</td>";
									
									echo "<td><input type=\"submit\" class=\"btn btn-danger btn-sm\"  name=\"delete[".$arr_msg['shortfile']."]\" value=\"Delete\"></td>";
					...
					<br>
					<input class="orange" type="submit" name="logout" value="logout"><br><br>
				</form>
			</div>
		</div>
...
<footer>
	<div class="row">
		<div class="col-md-6">
			<p>Created by Voicemail Server (<a href="#">Voicemail</a>)  -  <?php echo gethostname(); ?></p>
		</div>
